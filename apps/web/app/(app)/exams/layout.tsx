...
/**
 * Examination console shell (M5, ADR-012; restyled per the design handoff §3 —
 * page header pattern + pill tab group). Admin-only (EXAM_MANAGE): teachers
      ...
      <section className="flex animate-fade-up flex-col gap-4">
        <div className="flex flex-col gap-1.5">
          ...
          <p className="text-sm text-ink-500">
            Plan exams, publish schedules and manage grading
            {activeYear ? (
              <>
                {" "}
